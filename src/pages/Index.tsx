...
const Index: React.FC = () => {
  ...
  return (
    <PageLayout>
      {/* 英雄区域 */}
      <section className="relative bg-gradient-to-b from-novel-primary/10 via-transparent to-transparent py-16 md:py-24">
      ...
      {/* 分类浏览 */}
      <section className="py-12 md:py-16 bg-novel-tertiary">
        <div className="container">
